 ...
 * Version History:
 * ~ ~ ~ ~ ~ ~ ~ ~ ~
 * 1.001  19-Jul-2010 Code adapted for Odin
...
public class GenericTable extends AbstractTableModel
{
   ...
   * @param columns An ArrayList containing the names of the columns stored as Strings
   * @param rows An ArrayList containing an array of entries to be stored in the table rows
   * @see java.util.ArrayList
   */
