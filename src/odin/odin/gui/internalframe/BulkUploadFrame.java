...
import odin.odin.object.table.*;

/**
 * Used for displaying the progress of Bulk Upload actions.
 * @version 1.001
 * @author Alexander J. Harris (email: Alexander.J.Harris(at)btinternet.com)
 */

public class BulkUploadFrame extends JInternalFrame
{
   ...
   */
  public BulkUploadFrame(String title, GenericTable gT)
  {
    ...
    jT.getColumnModel().getColumn(1).setCellRenderer(new ProgressRenderer());
    ...
    log.log(Level.FINEST, "Displaying new bulk upload frame for: {0}", title);
  }
